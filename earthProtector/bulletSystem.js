class BulletSystem {
  ...
  edges(){
      ...
      for(var i = 0; i < this.bullets.length; i++){
//          if(this.bullets[i].x > width - this.diam / 2 || this.bullets[i].x < this.diam / 2){
//              this.bullets.splice(i, 1);
//          }
          
          
//          if(this.bullets[i].y > height || this.bullets[i].y < this.diam - height){
//              this.bullets.splice(i, 1);
//          }
          
          if(this.bullets[i].y < this.diam - height){
              this.bullets.splice(i, 1);
          }
